...
.. <<configuring-version-management-for-rke2-and-k3s-clusters,Configure the version management feature for imported RKE2 and K3s clusters>>.
. Click *Create*.
...
* Enable or disable <<configuring-version-management-for-rke2-and-k3s-clusters,version management>>
...
* Configure the <<configuring-rke2-and-k3s-cluster-upgrades,upgrade strategy>> when version management is enabled
