...
After {sainodeinstaller} completes successfully, the nodes are fully prepared for deploying {productname} workloads.
Deploy the required applications as described in xref:ai-library-installing[].