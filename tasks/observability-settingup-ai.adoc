...
The difference between deployment scenarios affects the *OTEL Collector exporter configuration* and the *{sobservability} Agent URL*.
Adjust the following values to match your {sobservability} configuration.
