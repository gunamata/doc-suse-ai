...
// https://github.com/rancher/rancher-product-docs/commits/main/versions/latest/modules/en/pages/installation-and-upgrade/install-rancher.adoc
...
You can automate key parts of your {productname} configuration and deployment.
This includes preparing {suse}-based servers for AI workloads by deploying {rke2a}, {ranchera}, {rancherprime}, {nvidia} GPU drivers and {nvoperator} using xref:ai-node-installer[{sainodeinstaller}].
